...
const ProfileInput = () => {
  ...
  //age over 12
  const [dateOfBirth, setDateOfBirth1] = useState(null);
  const [validate, setValidate] = useState('false');
  const [validationError, setValidationError] = useState(null);
  const [validatFirstName, setValidatFirstName] = useState(null);
  const [validatLastName, setValidatLastName] = useState(null);
  const [validatEmail, setValidatEmail] = useState(null);
  const [validatPassword, setValidatPassword] = useState(null);
  const [validatVerifyPassword, setValidatVerifyPassword] = useState(null);
  const [passwordInput, setPasswordInput] = useState(null);
  const [validatPhoneNumber, setValidatPhoneNumber] = useState(null);
                ...
                <div className="row row-space ">
                  <div className="col-2 ">
                    <div className="input-group">
                      ...
                      />
                      {errors.firstName && <p className="error-message text-danger">*lets see if its working</p>}
                    </div>
                    {validatFirstName && (
